...
birds = [
	...
	{name: "Persephone"},
	{name: "Sully"},      
	{name: "Sebastian", goal_amount: 2500, goal_progress: 3000, progress: "100%", story: "Sebastian was found on a local buy/sell paper offering a cockatoo for cheap. After posting about it and forwarding me a photo, it was clear this bird has a severe prolapse that needs medical attention.</p><p>Sebastian was living in a 10 x 10 shack with a dozen other birds in a small 18 x 18 rusty cage, with no toys, a single perch, sunflower seed diet, and a prolapse. This is a severe prolapse and the owners claim it has been 'like that' for the past 6 months. The bird has been outside in this unheated shack during 20 degree weather.</p><p>Between my friend, myself, and a group of online bird buddies I networked and scraped together a ransom fee for the bird, as well as located a rescue willing to take him in.</p><p>After about 6 hours of driving, collecting the bird, dropping him off to quarantine at a friends house (a no pet household), we arrived home. Sebastian was then transported to Miss Vicki’s Parrot Village, to a rescue in Georgia, where he already has a vet appointment lined up. The trip was an 8 hours long drive time.</p><p>We took Sebastian to the vet. He did great, and he was so excited to be home that he stepped up out of their carriers!</p><p>The prognosis for Sebastian is not so good, but his Veterinarian is helping us work with him. She sutured his vent, gave him some pain meds and antibiotics, and even trimmed his nails while he was under anesthesia...I am sure he is grateful for that.</p><p>We are going to give him the best shot possible. Hopefully getting him on a good diet and in a healthy atmosphere will help him improve enough where his quality of life is not inhumane.</p><p>He will be going back in for another surgery, but we are going to work with the other issues while these sutures are in place. Please keep him in your thoughts, and we will keep you posted daily!"},
]
...
birds.each do |bird|
	...
	Animal.create({
		...
		age: Forgery::Basic.number(at_least: 1, at_most: 20),
		gender: rand(0..1),
		goal_amount: ( bird[:goal_amount] ? bird[:goal_amount] : goal ),
		goal_progress: ( bird[:goal_progress] ? bird[:goal_progress] : goal_progress.to_i ),
		progress: ( bird[:progress] ? bird[:progress] : sprintf("%g", ((goal_progress / goal) * 100)) + "%" ),
